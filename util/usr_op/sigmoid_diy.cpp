...
public:
  ...
  void Compute(OpKernelContext * context) override {
	...
	for (int i = 0; i < N; i++) {
	  if (fabs(input(i)) > 0 && fabs(input(i)) <= 1)
	    tmp_data = 0.22830 * fabs(input(i)) + 0.50596;
	  else if (fabs(input(i)) > 1 && fabs(input(i)) <= 2)
	    tmp_data = 0.14945 * fabs(input(i)) + 0.58948;
	  else if (fabs(input(i)) > 2 && fabs(input(i)) <= 3)
	    tmp_data = 0.06749 * fabs(input(i)) + 0.75292;
	  else if (fabs(input(i)) > 3 && fabs(input(i)) <= 4)
	    tmp_data = 0.02739 * fabs(input(i)) + 0.87367;
	  else if (fabs(input(i)) > 4 && fabs(input(i)) <= 5)
	    tmp_data = 0.01046 * fabs(input(i)) + 0.94147;
	  else if (fabs(input(i)) > 5 && fabs(input(i)) <= 6)
	    tmp_data = 0.00390 * fabs(input(i)) + 0.97428;
	  else if (fabs(input(i)) > 6 && fabs(input(i)) <= 7)
	    tmp_data = 0.00144 * fabs(input(i)) + 0.98905;
	  else if (fabs(input(i)) > 7 && fabs(input(i)) <= 8)
	    tmp_data = 0.00053 * fabs(input(i)) + 0.99543;
	  else if (fabs(input(i)) > 8 )
	    tmp_data = 1;
